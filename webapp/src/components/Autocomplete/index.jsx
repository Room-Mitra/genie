  ...
  return (
    <div className="w-full" ref={wrapperRef}>
      <div className="relative">
        ...
        {open && (
          <div className="absolute z-50 mt-1 w-full overflow-hidden rounded-xl border border-gray-700 bg-white shadow-lg dark:bg-gray-900">
            {loading ? (
              ...
              <ul ref={listRef} className="max-h-64 overflow-auto">
                {items.map((it, idx) => (
                  <li
                    key={idx}
                    className={cn(
                      "cursor-pointer px-3 text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-800",
