...
import { HotelRoleLabels, Roles } from "./roles";
import { Department, DepartmentLabels } from "./department";
    ...
    <div className={cn("flex items-center gap-3 rounded-lg p-3", width)}>
      ...
      <div>
        ...
        {showDepartment && department && (
          <Department department={department} size="sm" />
        )}
        {showRoles && roles && <Roles roles={roles} />}
      </div>
    </div>
  );
}
