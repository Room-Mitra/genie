...
const CheckOut = () => {
    ...
    const confirmCheckOut = () => {
        console.log(`Guest in room ${roomNumber} checked out.`);
        setShowModal(false);
    };
        ...
        <Container>
            ...
            {bookingDetails && (
                <div>
                    ...
                    <Button primary onClick={handleGuestCheckOut}>Check Out</Button>
                </div>
            )}
            ...
            {showModal && (
                <>
                    ...
                    <ConfirmationModal>
                        ...
                        <Button primary onClick={confirmCheckOut}>Confirm</Button>
