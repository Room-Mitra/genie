      ...
      >
        ...
        <label style={{ display: 'flex', flexDirection: 'column', fontWeight: 'bold' }}>
          ...
          <input
            ...
            onChange={handleGuestPhoneNumberChange}
            style={{
              padding: '8px',
              border: '1px solid #ccc',
              borderRadius: '5px',
        ...
        <button
          type="button"
          onClick={handleFetchGuestDetailsClick}
          style={{
            ...
            <div style={{ marginTop: '20px' }}>
              ...
              <label style={{ display: 'flex', flexDirection: 'column', fontWeight: 'bold' }}>
                ...
                <input
                  ...
                  onChange={(event) =>
                    setGuestDetails({ ...guestDetails, name: event.target.value })
                  }
                  style={{
                    padding: '8px',
                    border: '1px solid #ccc',
              ...
              <label style={{ display: 'flex', flexDirection: 'column', fontWeight: 'bold' }}>
                ...
                <input
                  ...
                  onChange={(event) =>
                    setGuestDetails({ ...guestDetails, email: event.target.value })
                  }
                  style={{
                    padding: '8px',
                    border: '1px solid #ccc',
              ...
              <button
                type="button"
                onClick={handleSaveGuestDetailsClick}
                style={{
                  backgroundColor: '#4CAF50',
                  color: 'white',
                  padding: '10px',
