...
router.post('/', async (req, res) => {
  ...
  console.log({ message: 'Order placed successfully', department, totalAmount, instructions, items, deviceId })
  res.status(200).json({ message: 'Order placed successfully', department, totalAmount, instructions, items });
