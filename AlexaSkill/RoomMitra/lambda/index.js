...
const CatchAllIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'CATCH_ALL';
    },
    async handle(handlerInput) {
        const userQuery = handlerInput.requestEnvelope.request.intent.slots.any.value
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome to RoomMitra, I am here to help you with anything you need.';
...
const FallbackIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Sorry, I don\'t know about that. Shall I connect you with the front desk ?';
        // TODO :: take consent and ask  frontdesk on whatsapp to connect with user
        return handlerInput.responseBuilder
            .speak(speakOutput)
            .reprompt(speakOutput)
            .getResponse();
