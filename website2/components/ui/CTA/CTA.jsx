          ...
          <div className="relative z-10">
            <div className="max-w-xl mx-auto text-center">
              ...
              <p className="mt-5 text-gray-300">
                Mailgo is the perfect answer! Our AI-based email marketing platform enables you to
                create highly targeted email campaigns that are tailored to each individual
                subscriber.
              </p>
            </div>
